...
<<<<<<< Updated upstream
    @unittest.skip('FIXME: finds dangerous functions calls in compiler generated code.')
=======
    @unittest.skip('FIXME: finds potentially dangerous functions in compiler generated functions.')
>>>>>>> Stashed changes
