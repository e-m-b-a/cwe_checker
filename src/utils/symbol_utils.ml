...
let check_calls (relevant_calls : concrete_call list) (prog : program term) (proj : 'a) (tid_map : 'b) (symbols : 'c) check_func =
...
let get_program_entry_points (program: program term) : sub term list =
